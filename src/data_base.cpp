...
bool data_base::create(block& genesis)
{
    ///////////////////////////////////////////////////////////////////////////
    ...
    const config::checkpoint& fork_point)
{
    ...
    {
        auto& rheader = *((*headers)[index]);
        const auto median_time_past = rheader.metadata.median_time_past;
        if ((ec = push_header(rheader, first_height + index, median_time_past)))
            return false;
    }
